...
contract StorageFactory {
    ...
    function sfGetNumber(
        ...
        SimpleStorage simpleStorage = simpleStorageList[_simpleStorageIndex];
        SimpleStorage.Person memory _person = simpleStorage.nameToPerson(_firstName, _lastName);
    ...
    function sfGetPerson(
        ...
        SimpleStorage simpleStorage = simpleStorageList[_simpleStorageIndex];
        SimpleStorage.Person memory _person = simpleStorage.retrievePerson(_personIndex);
        return _person;
    }
    ...
    function sfGetPerson(
        ...
        _person = simpleStorageList[_simpleStorageIndex].nameToPerson(_firstName, _lastName);
    }
