...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var provider, wallet, abi, binary, nonce, tx, sentTxResponse;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    provider = new ethers_1.ethers.providers.JsonRpcProvider("http://127.0.0.1:7545");
                    wallet = new ethers_1.ethers.Wallet("fa3ab1f9da733df326ab484fd49ff991f667c673d15c5b1c428e0867564511e3", provider);
                    ...
                    return [4 /*yield*/, wallet.getTransactionCount()];
                case 1:
                    nonce = _a.sent();
                    tx = {
                        nonce: nonce,
