...
contract StorageFactory {
  ...
  function sfGetAddress(uint256 _simpleStorageIndex)
    public
    view
    returns (address)
  {
    return address(simpleStorageList[_simpleStorageIndex]);
  }
